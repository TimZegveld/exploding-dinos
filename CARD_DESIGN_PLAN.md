...
| `dig` | Diep Graven | Actie | Dino graaft naar onderste laag/fossiel, aardlagen zichtbaar. | `cartoon dinosaur digging deep through layered soil toward a buried fossil, cross section of earth, warm earthy colors, no text` |
...
| `miniRaptor` | Mini-Raptor | Soortkaart | Kleine snelle raptor als karakterportret. | `tiny cute cartoon raptor standing proudly, oversized curious eyes, small claws, simple prehistoric background, no text` |
| `stegoSnack` | Stego Snack | Soortkaart | Stegosaurus met snack/plant, vriendelijk en herkenbaar. | `friendly cartoon stegosaurus happily eating a prehistoric leafy snack, chunky plates, warm cheerful colors, no text` |
